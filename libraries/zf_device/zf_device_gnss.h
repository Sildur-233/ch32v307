...
//引脚配置
//--------------------------------------------------------------------------------------------------
#define GNSS_UART           (UART_8)
#define GNSS_RX             (UART8_MAP3_TX_E14)                                      // GPS RX引脚连接到单片机此
#define GNSS_TX             (UART8_MAP3_RX_E15)                                      // GPS TX串口引脚
...
typedef struct
{
    ...
    float       antenna_direction_state;                                        // 双天线测向有效状态 1：测向有效  0：测向无效，无效时antenna_direction数据是无效的
